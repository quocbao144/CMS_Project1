...
const SiderWeb = () => {
  ...
  return (
    ...
    >
      ...
      <Menu
        style={{ background: "#E5E5E5", fontSize: "24px", borderRadius: "5px" }}
        mode="inline"
        defaultSelectedKeys={['1']}
      >
        <Menu.Item key="1" style={{ borderRadius: "15px" }}  icon={<img src={Icon_home} />}>
          <Link to="/">
            Trang chủ
          </Link>
        </Menu.Item>

        <Menu.Item key="2" style={{ borderRadius: "15px" }} icon={<img src={Icon_manage} />}>
          <Link to="/ticket-manage/events">
            Quản lý vé
          </Link>
        </Menu.Item>

        <Menu.Item key="3" style={{ borderRadius: "15px" }} icon={<img src={Icon_control} />}>
        ...
        <SubMenu key="sub3"  title="Cài đặt"  icon={<img src={Icon_setting} />}>
          <Menu.Item key="11" style={{ borderRadius: "15px" }}>
